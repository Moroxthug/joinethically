    ...
    <div className="wrap">
      ...
      <div style={{ paddingBottom: 64 }}>
        ...
        <div className="coming-soon" style={{ marginTop: 8 }}>
          The full 340-company directory — searchable, sortable by score and category, with
          score-change history per entity — is the next build milestone. Companies can request a
          factual right-of-reply on any scorecard; see{" "}
